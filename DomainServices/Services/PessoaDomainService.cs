...
{
    public class PessoaDomainService : DomainServiceCartorioNew<PessoaCartorioNew>, IPessoaDomainService
    {
        ...
        public PessoaDomainService(IUnitOfWorkDataBaseCartorio UfwCart, IUnitOfWorkDataBaseCartorioNew UfwCartNew) : base(ufwCart, UfwCartNew)
        {
            //
        }
