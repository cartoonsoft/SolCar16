...
{
    public class ArquivoModeloDocxDomainService : DomainServiceCartorioNew<ArquivoModeloDocx>, IArquivoModeloDocxDomainService
    {
        ...
        public ArquivoModeloDocxDomainService(IUnitOfWorkDataBaseCartorio UfwCart, IUnitOfWorkDataBaseCartorioNew UfwCartNew) : base(ufwCart, UfwCartNew)
        {
