...
namespace Cartorio11RI.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        //todo: comentei AccountRegisterViewModel
        // GET: Usuarios/Create
        ...
        //public async Task<ActionResult> Create([Bind(Include = "Id,IdCtaAcessoSist, Admin,Ativo,Nome,Username,Email,EmailConfirm,Password,PasswordConfirm,PhoneNumber")] AccountRegisterViewModel accountRegisterViewModel)
        //{
