...
namespace AppServCart11RI.Base
{
    ...
    {
        public AppServiceCartorio11RI(IUnitOfWorkDataBaseCartNew UfwCartNew, long IdCtaAcessoSist, IDomainServicesFactoryCartNew dsFactoryCartNew = null, string pathErroLog = null) : base(UfwCartNew, IdCtaAcessoSist, dsFactoryCartNew, pathErroLog)
        {
