...
namespace SmartAdminMvc
{
    ...
    public static class Settings
    {
        ...
        /// </summary>
        public static readonly string Company = GetValue<string>("Cartoon Soft");

        /// <summary>
        ///     Retrieves the entry value for the following composed key: "config:Project" as a string.
        /// </summary>
        public static readonly string Project = GetValue<string>("Cart-16");
        ...
        /// </summary>
        public static readonly string CurrentTheme = GetValue<string>("Dark Elegance");
