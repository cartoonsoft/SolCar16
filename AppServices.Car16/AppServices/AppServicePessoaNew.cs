...
{
    public class AppServicePessoaNew : AppServiceCartorio<DtoPessoaCartorioNew, PessoaCartNew>, IAppServicePessoaNew
    {
        //private List<DtoPessoaPesxPre> listaDtoPessoaPesxPre = null;

        public AppServicePessoaNew(IUnitOfWorkDataBaseCartorio UfwCart, IUnitOfWorkDataBaseCartorioNew UfwCartNew): base(UfwCart, UfwCartNew)
        {
            //
